  ...
  if ($result && $result->num_rows > 0) {
    ...
    $actor = $_POST['actor'];
      ...
      if ($_FILES["image"]["name"]) {
        ...
        $sql = "UPDATE movie SET name='$name', genre = '$genre', industry = '$industry', language = '$language', duration = '$duration', reldate = '$reldate', director = '$director', actor = '$actor', price='$price', fdate='$fdate', sdate = '$sdate', fshow='$fshow', sshow='$sshow', tshow='$tshow' WHERE id=$id";
        $result = $conn->query($sql);
